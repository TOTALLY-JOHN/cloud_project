                        ...
                        <div class="card mb-4" style="overflow-x: auto;">
                            <div class="card-body">
                                <table style="width:100%;">
                                    <tr>
                                        <td><a id="createVMBtn" href="create_vm.php" class="btn btn-primary"><?php echo $languages[$lang]['create_new_vm'];?> +</a></td>
                                        <td>
                                    ...
                                    <tbody id="vmTable">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo number_format($row['storageAllocation'] / 1000000000, 2); ?>GB</td>
                                                <td><?php echo number_format($row['memoryAllocation'] / 1000, 2); ?>mib</td>
